    ...
    <footer className="text-center py-6 border-t border-white/5 bg-black mt-auto">
      <div className="flex flex-col items-center space-y-6 max-w-6xl mx-auto px-4">
        ...
        <div className="flex items-center gap-6">
          <a href="https://meatdepot.co.za" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors" aria-label="Website">
            <Globe size={20} />
          </a>
          <a href="https://facebook.com/meatdepotgq" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors" aria-label="Facebook">
            <Facebook size={20} />
          </a>
          <a href="https://www.instagram.com/meatdepotgq/" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors" aria-label="Instagram">
            <Instagram size={20} />
          </a>
          <a href="mailto:admin@meatdepot.co.za" className="text-white/40 hover:text-white transition-colors" aria-label="Email Us">
            <Mail size={20} />
          </a>
          <a href="https://wa.me/844012488038318" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors" aria-label="WhatsApp">
