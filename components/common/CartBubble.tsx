...
const CartBubble: React.FC = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-8 right-8 z-[150] bg-[#f4d300] text-black pl-5 pr-6 py-4 rounded-full shadow-[0_0_30px_rgba(244,211,0,0.5)] hover:scale-105 active:scale-95 transition-all duration-300 flex items-center gap-4 group animate-in slide-in-from-bottom-10 fade-in border-2 border-black"
    >
